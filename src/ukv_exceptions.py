...
class UKVBadKeyListException(Exception):
    def __init__(self, message='Invalid keys specified in the JSON list.  See logs', data='{}'):
        super().__init__(message)
        self.data = data

class UKVRequestedKeysNotFoundException(Exception):
    def __init__(self, message='Keys specified in the JSON list were not found.  See logs', data='{}'):
        super().__init__(message)
        self.data = data
